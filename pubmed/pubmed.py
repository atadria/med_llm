# original file: https://huggingface.co/datasets/pubmed/blob/main/pubmed.py
# Limited fields
# change range in line 44 if you want to limit data
...
_URLs = [f"https://ftp.ncbi.nlm.nih.gov/pubmed/baseline/pubmed24n{i:04d}.xml.gz" for i in range(1, 1220, 50)]
